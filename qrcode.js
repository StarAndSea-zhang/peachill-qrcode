...
(function (root, factory) {
	 ...
	 * });
        ...
        * @param {String} [vOption.centerIconSrc=""]
        * @param {String} [vOption.iconWidth=""]
        * @param {String} [vOption.iconHeight=""]
        * @param {String} [vOption.linearGradient = true]
        * @param {String} [vOption.linearGradientFrom=""]
        * @param {String} [vOption.linearGradientTo=""]
        * @param {String} [vOption.linearGradientMiddle=""]
        * @param {String} [vOption.linearGradientDirection="to right"] // 默认 to right  支持to bottom、to top、to right、to left、to bottom right
        */
       QRCode = function (el, vOption) {
           ...
           this._htOption = {
               ...
               centerIconSrc:undefined,
               linearGradient:false,
               linearGradientFrom:'#000000',
               linearGradientMiddle:undefined,
               linearGradientTo:'#cecece'
           };
           ...
           // document.getElementById 只能通过id寻找 修改为匹配制定选择器
           if (typeof el == "string") {
       ...
       QRCode.prototype.makeCode = function (sText) {
           ...
           //Auther By Zoe
           if(typeof(this._htOption.centerIconSrc) !== "undefined"&&this._htOption.centerIconSrc!=='') {
               //这里是异步的函数，只有加了await才会变成同步（注意：即使函数里面有await，这个函数也是异步执行的）
               console.log(this._oDrawing)
               this._oDrawing.addIcon(this._htOption.centerIconSrc);
           }
       ...
       /**
        * @name QRCode.CorrectLevel 纠错处理
        */
       QRCode.CorrectLevel = QRErrorCorrectLevel;

       /**
        * Auther by zoe
        * @name QRGradientDirection 渐变色方向
        */
